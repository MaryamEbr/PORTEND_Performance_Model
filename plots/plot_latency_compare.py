...
resnet20_accuracy_constraint = 0.85
...
ns_latency_perf_vggish = vggish_perf_df.loc[(effb0_perf_df['partial_flag'] == False) & (effb0_perf_df['threshold'] == 0) & (effb0_perf_df['placement'].astype(str)!='[0, 1]') & (effb0_perf_df['placement'].astype(str)!='[1]') & (vggish_perf_df['estimated_accuracy'] >= vggish_accuracy_constraint)]\
                        .sort_values(by=['estimated_e2e_latency', 'estimated_accuracy'], ascending=[True, False])
...
bar1 = [cloud_latency_perf_resnet20_0, cloud_latency_perf_resnet110_0, cloud_latency_perf_effnetb0_0, cloud_latency_perf_vggish_0]
bar2 = [edge_latency_perf_resnet20_0, edge_latency_perf_resnet110_0, edge_latency_perf_effnetb0_0, edge_latency_perf_vggish_0]
bar3 = [ns_latency_perf_resnet20_0, ns_latency_perf_resnet110_0, ns_latency_perf_effnetb0_0, ns_latency_perf_vggish_0]
bar4 = [our_latency_perf_resnet20_0, our_latency_perf_resnet110_0, our_latency_perf_effnetb0_0, our_latency_perf_vggish_0]
...
ax.set_ylabel('latency (minimized)')
...
# OUR
# resnet20
#  [list([[1, 7], [8, 9]]) list([0, 2]) 0.8 11.573291782007562]
our_latency_exp_resnet20 = resnet20_exp_df.loc[(resnet20_exp_df['placement'].astype(str) == '[0, 2]') & (resnet20_exp_df['partitioning'].astype(str) == '[[1, 7], [8, 9]]') & (resnet20_exp_df['threshold'] == 0.8) & (resnet20_exp_df['destination_tier']==destination_tier) & (resnet20_exp_df['source_wait']!=270) & (resnet20_exp_df['model_mode']=='full')]\
                            .sort_values(by=['e2e_tail_mean', 'accuracy'], ascending=[True, False])
# resnet110
#  [list([[1, 29], [30, 38]]) list([0, 2]) 0.7 47.25166194533133]
our_latency_exp_resnet110 = resnet110_exp_df.loc[(resnet110_exp_df['placement'].astype(str) == '[0, 2]') & (resnet110_exp_df['partitioning'].astype(str) == '[[1, 29], [30, 38]]') & (resnet110_exp_df['threshold'] == 0.7) & (resnet110_exp_df['destination_tier']==destination_tier) & (resnet110_exp_df['source_wait']!=270) & (resnet110_exp_df['model_mode']=='full') ]\
                            .sort_values(by=['e2e_tail_mean', 'accuracy'], ascending=[True, False])
# effb0
#  [[list([[1, 4], [5, 8]]) list([0, 1]) 0.2 430.72603812030144]
our_latency_exp_effnetb0 = effb0_exp_df.loc[(effb0_exp_df['placement'].astype(str) == '[0, 1]') & (effb0_exp_df['partitioning'].astype(str) == '[[1, 4], [5, 8]]') & (effb0_exp_df['threshold'] == 0.2) & (effb0_exp_df['destination_tier']==destination_tier) & (effb0_exp_df['source_wait']!=707) & (effb0_exp_df['model_mode']=='full') ]\
                            .sort_values(by=['e2e_tail_mean', 'accuracy'], ascending=[True, False])
# vggish
#  [list([[1, 4]]) list([2]) 0.0 1880.1220841633308]
...
bar1 = [cloud_latency_exp_resnet20_0, cloud_latency_exp_resnet110_0, cloud_latency_exp_effnetb0_0, cloud_latency_exp_vggish_0]
bar2 = [edge_latency_exp_resnet20_0, edge_latency_exp_resnet110_0, edge_latency_exp_effnetb0_0, edge_latency_exp_vggish_0]
bar3 = [ns_latency_exp_resnet20_0, ns_latency_exp_resnet110_0, ns_latency_exp_effnetb0_0, ns_latency_exp_vggish_0]
bar4 = [our_latency_exp_resnet20_0, our_latency_exp_resnet110_0, our_latency_exp_effnetb0_0, our_latency_exp_vggish_0]
...
# Add labels, title, and legend
ax.set_ylabel('Minimized Latency (ms)')
