...
def waveform_to_examples(data, sample_rate, return_tensor=True):
  ...
  """
    ...
    # print("before resample ", data.shape[0], " . rate ", sample_rate)
    if sample_rate != vggish_params.SAMPLE_RATE:
        data = resampy.resample(data, sample_rate, vggish_params.SAMPLE_RATE)
    # print("after resample ", data.shape, " . rate ", sample_rate)
    ...
    # print("log mel shape before frame ", log_mel.shape)
    ...
    # print("log mel shape after frame ", log_mel_examples.shape)
